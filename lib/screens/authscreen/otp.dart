...
import 'package:wegast/screens/enablelocation.dart';
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                LanguageFr.verificationcodeotp,
                style: TextStyle(
          ...
          Row(
            children: [
              SizedBox(width: width / 20),
              Text(
                LanguageFr.averificationcodeshasbeensendto,
                style: TextStyle(
          ...
          Row(
            ...
            children: [
              Text(
                LanguageFr.dontreceivedthecode,
                style: TextStyle(
